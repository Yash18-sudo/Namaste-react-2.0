...
const Header = () =>{
    return <div className="header">
        <div className="logo-container">
            <img className="logo"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSeilPKkfedUrAj3ysfj-MYwncq6YxCf_pvw&usqp=CAU"
            />
        </div>
...
const RestaurantCard = (props)=>{
    ...
    return <div className="res-card">
        <img
           className='res-logo'
           alt="res-logo"
           src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_180,h_180,c_fill/"+cloudinaryImageId}
